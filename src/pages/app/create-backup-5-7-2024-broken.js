...
const importFromUrl = async (event) => {
  ...
  try {
    ...
    // Replace the entire text in the Quill editor 'editorBrandServiceOrProduct'
    editorBrandServiceOrProduct.setText(textToReplace + "\n"); // Add a newline at the end for convenience
  } catch (error) {
